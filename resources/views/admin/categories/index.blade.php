          ...
          <div class="card-body pb-4">
            ...
            <section class="card border-0 mb-4" id="tables-color-borders">
              <div class="card-body pb-0 d-flex justify-content-between ">
                ...
                <a class="btn btn-light" target="_blank" href="{{ route('admin.categories.create') }}"> <i class="ai-plus text-primary"></i> </a>
              </div>
              <div class="card-body">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a  target="_blank" href="{{ route('admin.categories.edit', ['category' => $category->id]) }}"> <i class="ai-edit-alt text-primary"></i> </a>
                        &nbsp;&nbsp;
