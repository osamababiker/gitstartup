                              ...
                              <div class="modal-body tab-content">
                                <form autocomplete="off">
                                  <div class="mb-3 mb-sm-4">
                                    ...
                                    <input type="text" class="form-control" id="en_name" placeholder="Enter project name in english">
                                  </div>
                                  <div class="mb-3 mb-sm-4">
                                    <label for="ar_name" class="form-label">Project name (arabic)</label>
                                    <input type="text" class="form-control" id="ar_name" placeholder="Enter project name in arabic">
                                  </div>
                                  <div class="mb-3 mb-sm-4">
