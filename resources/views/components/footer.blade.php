        ...
        <div class="row pb-2">
          ...
          <div class="col-sm-4 col-lg-2 offset-lg-1 mb-4 mb-sm-0 {{ (App::isLocale('ar') ?  ' offset-xr-2 offset-xxr-3' : ' offset-xl-2 offset-xxl-3') }}">
            ...
            <ul class="nav flex-column fs-sm px-0">
              ...
              <li class="nav-item"><a class="nav-link fw-normal px-0 py-1" href="#">{{ __('navbar.about_link') }}</a></li>
              <li class="nav-item"><a class="nav-link fw-normal px-0 py-1" href="#">{{ __('navbar.projects_link') }}</a></li>
              <li class="nav-item"><a class="nav-link fw-normal px-0 py-1" href="#">{{ __('navbar.blogs_link') }}</a></li>
            </ul>
          </div>
